...
flow_vulnerability00_chinook = fishmod_utils.stream_mod(flow, fo=424, a=12818, b=424) # Chinook
flow_vulnerability00_sockeye = fishmod_utils.stream_mod(flow, fo=390, a=946, b=390) # Sockeye
flow_vulnerability00_coho = fishmod_utils.stream_mod(flow, fo=362, a=12124, b=362) # Coho
flow_vulnerability00_pink = fishmod_utils.stream_mod_pink(flow, a_max=1052, f_max=1200, f_min=0, f_opt=420) # Pink
# Stream flow 2040s
flow = data_wea40["Streamflow"]
flow_vulnerability40_chinook = fishmod_utils.stream_mod(flow, fo=424, a=12818, b=424) # Chinook
flow_vulnerability40_sockeye = fishmod_utils.stream_mod(flow, fo=390, a=946, b=390) # Sockeye
flow_vulnerability40_coho = fishmod_utils.stream_mod(flow, fo=362, a=12124, b=362) # Coho
flow_vulnerability40_pink = fishmod_utils.stream_mod_pink(flow, a_max=1052, f_max=1200, f_min=0, f_opt=420) # Pink
# stream flow 2080s
flow = data_wea80["Streamflow"]
flow_vulnerability80_chinook = fishmod_utils.stream_mod(flow, fo=424, a=12818, b=424) # Chinook
flow_vulnerability80_sockeye = fishmod_utils.stream_mod(flow, fo=390, a=946, b=390) # Sockeye
flow_vulnerability80_coho = fishmod_utils.stream_mod(flow, fo=362, a=12124, b=362) # Coho
flow_vulnerability80_pink = fishmod_utils.stream_mod_pink(flow, a_max=1052, f_max=1200, f_min=0, f_opt=420) # Pink

### Combining temperature & streamflow vulnerability projections, assigning equal weight to each output
# Historical
chinook_vulnerability00 = pd.DataFrame(round(temp_vulnerability00*0.5 + flow_vulnerability00_chinook*0.5)) # Chinook
sockeye_vulnerability00 = pd.DataFrame(round(temp_vulnerability00*0.5 + flow_vulnerability00_sockeye*0.5)) # Sockeye
coho_vulnerability00 = pd.DataFrame(round(temp_vulnerability00*0.5 + flow_vulnerability00_coho*0.5)) # Coho
pink_vulnerability00 = pd.DataFrame(round(temp_vulnerability00*0.5 + flow_vulnerability00_pink*0.5)) # Pink
# Year 2040s
chinook_vulnerability40 = pd.DataFrame(round(temp_vulnerability40*0.5 + flow_vulnerability40_chinook*0.5)) # Chinook
sockeye_vulnerability40 = pd.DataFrame(round(temp_vulnerability40*0.5 + flow_vulnerability40_sockeye*0.5)) # Sockeye
coho_vulnerability40 = pd.DataFrame(round(temp_vulnerability40*0.5 + flow_vulnerability40_coho*0.5)) # Coho
pink_vulnerability40 = pd.DataFrame(round(temp_vulnerability40*0.5 + flow_vulnerability40_pink*0.5)) # Pink
# Year 2080s
chinook_vulnerability80 = pd.DataFrame(round(temp_vulnerability80*0.5 + flow_vulnerability80_chinook*0.5)) # Chinook
sockeye_vulnerability80 = pd.DataFrame(round(temp_vulnerability80*0.5 + flow_vulnerability80_sockeye*0.5)) # Sockeye
coho_vulnerability80 = pd.DataFrame(round(temp_vulnerability80*0.5 + flow_vulnerability80_coho*0.5)) # Coho
pink_vulnerability80 = pd.DataFrame(round(temp_vulnerability80*0.5 + flow_vulnerability80_pink*0.5)) # Pinks
