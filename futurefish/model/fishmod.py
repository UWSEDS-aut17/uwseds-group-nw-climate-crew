...
# Historical
chinook_vulnerability00 = pd.DataFrame(round(temp_vulnerability00*0.5 +
                                             flow_vulnerability00_chinook*0.5))
sockeye_vulnerability00 = pd.DataFrame(round(temp_vulnerability00*0.5 +
                                             flow_vulnerability00_sockeye*0.5))
coho_vulnerability00 = pd.DataFrame(round(temp_vulnerability00*0.5 +
                                          flow_vulnerability00_coho*0.5))
pink_vulnerability00 = pd.DataFrame(round(temp_vulnerability00*0.5 +
                                          flow_vulnerability00_pink*0.5))

# Year 2040s
chinook_vulnerability40 = pd.DataFrame(round(temp_vulnerability40*0.5 +
                                             flow_vulnerability40_chinook*0.5))
sockeye_vulnerability40 = pd.DataFrame(round(temp_vulnerability40*0.5 +
                                             flow_vulnerability40_sockeye*0.5))
coho_vulnerability40 = pd.DataFrame(round(temp_vulnerability40*0.5 +
                                          flow_vulnerability40_coho*0.5))
pink_vulnerability40 = pd.DataFrame(round(temp_vulnerability40*0.5 +
                                          flow_vulnerability40_pink*0.5))

# Year 2080s
chinook_vulnerability80 = pd.DataFrame(round(temp_vulnerability80*0.5 +
                                             flow_vulnerability80_chinook*0.5))
sockeye_vulnerability80 = pd.DataFrame(round(temp_vulnerability80*0.5 +
                                             flow_vulnerability80_sockeye*0.5))
coho_vulnerability80 = pd.DataFrame(round(temp_vulnerability80*0.5 +
                                          flow_vulnerability80_coho*0.5))
pink_vulnerability80 = pd.DataFrame(round(temp_vulnerability80*0.5 +
